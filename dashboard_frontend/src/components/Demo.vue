...
<template type="x-template" id="demo-template">
    <div id="demo-template">
        <div class="block fullwidth">
            ...
            {{ $t("feature.create_list.introduction") }}

            <figure>
              <p><img src="/static/images/demo/domain_list.png" class="scaled" alt="example list">
            ...
            <table>
                <tr>
                    <td style="vertical-align: top; text-align: left">
                        <figure>
                          <p><img src="/static/images/demo/text_upload.png" class="scaled" alt="example list">
                          <figcaption>{{ $t("feature.create_list.text_upload_caption") }}</figcaption>
                        </figure>
                    </td>
                    <td style="vertical-align: top; text-align: left">
                        <figure>
                          <p><img src="/static/images/demo/spreadsheet_upload.png" class="scaled" alt="example list">
            ...
            <figure>
              <p><img src="/static/images/demo/scan_progress.png" class="scaled" alt="example list">
            ...
            <figure>
              <p><img src="/static/images/demo/report_configuration.png" class="scaled" alt="example list">
            ...
            <figure>
              <p><img src="/static/images/demo/graph_timeline.png" class="scaled" alt="example list">
            ...
            <figure>
              <p><img src="/static/images/demo/bar_chart.png" class="scaled" alt="example list">
            ...
            <figure>
              <p><img src="/static/images/demo/result_table.png" class="scaled" alt="example list">
            ...
            <figure>
              <p><img src="/static/images/demo/spreadsheet.png" class="scaled" alt="example list">
    ...
    i18n: {
        messages: {
            en: {
                ...
                introduction: "The internet.nl allows bulk scans and reporting up to thousands of domains. <br> Scan for IPv6, TLS, DMARC, SPF, DANE, DKIM, DNSSEC, HTTP Headers and more.<br> Below is an overview of features included in the dashboard:",
