    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('internet_nl_api_password', models.TextField(blank=True,
                ...
                ('report_settings', jsonfield.fields.JSONField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mail_send_mail_after_scan_finished', models.BooleanField(default=False,
                                                                           help_text='After a scan is finished, an e-mail is sent informing the user that a report is ready.')),
                ('mail_after_mail_unsubscribe_code', models.CharField(blank=True, default='',
                                                                      help_text='This is autofilled when sending an e-mail. The user can use this code to set mail_send_mail_after_scan_finished to false without logging in.', max_length=255)),
            ],
        ),
        migrations.CreateModel(
            name='UploadLog',
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, help_text='What user performed this upload.', null=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enable_scans', models.BooleanField(default=True)),
                ('scan_type', models.CharField(choices=[('web', 'web'),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_endpoint_issues', models.IntegerField(default=0,
                                                              help_text='A sum of all endpoint issues for this endpoint, it includes all high, medium and lows.')),
                ('endpoint_issues_high', models.IntegerField(default=0,
                ...
                ('endpoint_issues_low', models.IntegerField(default=0,
                                                            help_text='Total amount of low risk issues on this endpoint')),
                ('endpoint_ok', models.IntegerField(default=0,
                ...
                ('endpoint_not_applicable', models.IntegerField(default=0,
                                                                help_text='Amount of things that are not applicable on this endpoint.')),
                ('endpoint_not_testable', models.IntegerField(default=0,
                ...
                ('url_not_applicable', models.IntegerField(default=0,
                                                           help_text='Amount of things that are not applicable on this url.')),
                ('url_not_testable', models.IntegerField(default=0,
                ...
                ('endpoint_error_in_test', models.IntegerField(default=0,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('report', models.ForeignKey(blank=True, help_text='After a scan has finished, a report is created. This points to that report so no guessing is needed to figure out what report belongs to what scan.',
