...
def test_render_comparison_view(db):
    ...
    output = render_comparison_view([], impact="improvement", language="nl")
    assert output == ""
    ...
    output = render_comparison_view(data, impact="improvement", language="nl")
    ...
    data = filter_comparison_report(deepcopy(comparison), "improvement")
    output = render_comparison_view(data, impact="improvement", language="en")
...
def test_determine_changes(current_path):
    ...
    assert determine_changes_in_ratings(
        ...
        "neutral": 0,
        "regression": 0,
        "improved_metrics": ["internet_nl_web_https_http_hsts"],
        "regressed_metrics": [],
        "neutral_metrics": [],
    }
    ...
    assert determine_changes_in_ratings(
        ...
        "regression": 1,
        "improved_metrics": [],
        "regressed_metrics": ["internet_nl_web_https_http_hsts"],
        "neutral_metrics": [],
    }
