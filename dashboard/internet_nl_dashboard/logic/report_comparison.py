...
def compare_report_in_detail(new_report, old_report) -> Dict[str, Any]:
    ...
    comparison_report: Dict[str, Union[Dict[str, Any], Any]] = {
        "urls_exclusive_in_new_report": list(
            set(new_report["calculation"]["urls_by_url"].keys()) - set(old_report["calculation"]["urls_by_url"].keys())
        ),
        "urls_exclusive_in_old_report": list(
            set(old_report["calculation"]["urls_by_url"].keys()) - set(new_report["calculation"]["urls_by_url"].keys())
        ),
        "old": {
