...
History and context for this manual: https://github.com/internetstandards/Internet.nl-dashboard/issues/495
...
Logging in
----------
Now you can login at http://localhost/admin/, or the same path under your server url.

The account of this user connects to the default internet.nl development scanning instance on http://localhost with
...
.. image:: docs/input/installation/admin_login_window.png

After a successful login you will see something that looks like this:

.. image:: docs/input/installation/admin_panel.png
...
.. image:: docs/input/installation/config_example_general_settings.png
...
4. Setup the API credentials for the account.
  ...
  2. http://127.0.0.1/admin/internet_nl_dashboard/account/
...
.. image:: docs/input/installation/config_setup_api_credentials.png
.. image:: docs/input/installation/config_credential_check.png
...
.. image:: docs/input/installation/scan_login_link.png
.. image:: docs/input/installation/admin_login_window.png
...
.. image:: docs/input/installation/scan_create_new_list.png

.. image:: docs/input/installation/scan_newly_created_list.png
...
.. image:: docs/input/installation/scan_adding_domains.png

.. image:: docs/input/installation/scan_adding_success.png

.. image:: docs/input/installation/scan_list_with_domains.png

5. start a scan by clicking 'scan now' and confirming the scan

.. image:: docs/input/installation/scan_scan_now.png
...
here: http://localhost/admin/django_mail_admin/outbox/
...
.. image:: docs/input/installation/email_configured_outbox.png
...
In the admin interface on http://localhost/admin/constance/config/ you will find the possibility to use subdomain
